...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Romania.PyTube.george_simion.george_simion_for_transcriber_YT
'''

transcriber_prep = Transcriber_data_Functions()

transcriber_prep.clean_transcribed_audio_files_setup(
    base_path='/work/YOU-DARE/scrapers/data/Romania/george_simion_YT/yt-dlp'
)