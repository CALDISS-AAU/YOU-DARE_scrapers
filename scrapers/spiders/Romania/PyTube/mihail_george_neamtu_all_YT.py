...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Romania.PyTube.mihail_neamtu_all_YT
...
channel_url = 'https://www.youtube.com/@mihailneamtuneoficial'
playlist1 = 'https://www.youtube.com/playlist?list=PLi0C8irncgr9JkutgKTPhL-VnRZhLCfnm'
playlist2 = 'https://www.youtube.com/playlist?list=PLi0C8irncgr-ERnKcECO-L6DpYElM-tXp'
