...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Romania.PyTube.claudiu_tarziu.claudiu_tarziu_all_YT
...
channel_url = 'https://www.youtube.com/@Claudiu.Tarziu' # videos, shorts and streams
...
Pytubefix_Functions.pytubefix_from_channel(channel_url, __file__, nesting_level=5, videos=True, shorts=True, live=True, check_for_downloaded=True)
Pytubefix_Functions.pytubefix_from_playlist(playlist1, __file__, nesting_level=5, source='Claudiu.Tarziu', check_for_downloaded=True)
Pytubefix_Functions.pytubefix_from_playlist(playlist2, __file__, nesting_level=5, source='Claudiu.Tarziu', check_for_downloaded=True)
Pytubefix_Functions.pytubefix_from_playlist(playlist3, __file__, nesting_level=5, source='Claudiu.Tarziu', check_for_downloaded=True)
Pytubefix_Functions.pytubefix_from_single(single_video, __file__, nesting_level=5, source='Claudiu.Tarziu')
