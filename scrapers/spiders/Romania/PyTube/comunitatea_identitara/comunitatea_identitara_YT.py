...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Romania.PyTube.comunitatea_identitara.comunitatea_identitara_YT
...
channel_url = 'https://www.youtube.com/@comunitateaidentitara8517/videos'
# source = 'Comunitatea Identitara YouTube'
