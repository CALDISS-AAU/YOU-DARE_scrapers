...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Romania.PyTube.comunitatea_identitara.comunitatea_identitara_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/Romania/comunitatea_identitara_YT'
