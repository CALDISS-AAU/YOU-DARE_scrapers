...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Spain.PyTube.info_vlogger.info_vlogger_YT
...
channel_url = 'https://www.youtube.com/@InfoVlogger/videos'
...
output_path = '/work/YOU-DARE/scrapers/data/Spain/info_vlogger_YT'
