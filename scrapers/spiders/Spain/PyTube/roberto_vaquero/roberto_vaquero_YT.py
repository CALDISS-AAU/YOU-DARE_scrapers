...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Spain.PyTube.roberto_vaquero.roberto_vaquero_YT
...
channel_url = 'https://www.youtube.com/@robertovaquero_/videos'
...
output_path = '/work/YOU-DARE/scrapers/data/Spain/roberto_vaquero_YT'
