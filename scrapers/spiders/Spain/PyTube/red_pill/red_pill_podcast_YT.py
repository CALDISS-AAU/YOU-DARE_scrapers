...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Spain.PyTube.red_pill.red_pill_podcast_YT
...
channel_url = 'https://www.youtube.com/@redpillpodcast_/videos'
...
output_path = '/work/YOU-DARE/scrapers/data/Spain/red_pill_podcast_YT'
