...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Spain.PyTube.vox_espana.vox_espana_YT
...
from_date = Pytubefix_Functions.parse_partial_date("2024")
to_date = Pytubefix_Functions.parse_partial_date("2026")

output_path = '/work/YOU-DARE/scrapers/data/Spain/vox_espana_YT'

# The link to the channel of interest
channel_url = 'https://www.youtube.com/c/VoxEspa%C3%B1aTV/videos'
...
Pytubefix_Functions.download_all_audio_until_complete(channel_url, output_path)
