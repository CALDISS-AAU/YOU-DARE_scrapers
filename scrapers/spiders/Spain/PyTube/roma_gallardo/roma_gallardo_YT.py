...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Spain.PyTube.roma_gallardo.roma_gallardo_YT
...
channel_url = 'https://www.youtube.com/@romagallardo7504/videos'
...
output_path = '/work/YOU-DARE/scrapers/data/Spain/roma_gallardo_YT'
