...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Spain.PyTube.wall_street_wolverine.wall_street_wolverine_YT
...
channel_url = 'https://www.youtube.com/@WallStreetWolverine/videos'
...
output_path = '/work/YOU-DARE/scrapers/data/Spain/wall_street_wolverine_YT'
