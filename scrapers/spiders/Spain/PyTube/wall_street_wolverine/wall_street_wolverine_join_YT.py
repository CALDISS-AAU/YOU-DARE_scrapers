...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Spain.PyTube.wall_street_wolverine.wall_street_wolverine_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/Spain/wall_street_wolverine_YT'
