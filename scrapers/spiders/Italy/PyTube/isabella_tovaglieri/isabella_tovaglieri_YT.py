...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Italy.PyTube.isabella_tovaglieri.isabella_tovaglieri_YT
    The first time this script is called after stating up a new UCloud session it will give the following message:
        Please open https://www.google.com/device and input code that you get from the terminal
...
channel_url = 'https://www.youtube.com/@isatovaglieri/videos'
