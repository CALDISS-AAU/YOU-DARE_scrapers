...
class StaticSpider(scrapy.Spider): 
    name = 'i_rami_spogli_static_SPIDER' # Spider name - used when calling the spider - must be unique within given project (for uniformity use {source}_static_SPIDER)
    region = 'Italy' # Parent folder - used for folderstructure within the data folder - must be the country of the source
    source = 'I Rami Spogli' # The source name - must be the actor of the website(s)
    start_urls = ['https://www.ramispogli.it/', 'https://www.ramispogli.it/page/2/', 'https://www.ramispogli.it/page/3/'] # List of all start_urls for the spider 
    ...
    links_in_text_XPATH = '//article/div/p/a/@href'
