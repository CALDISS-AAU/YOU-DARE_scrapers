...
COOKIES="/work/YOU-DARE/scrapers/scrapers/functions/carbombschematics.txt"
FFMPEG_DIR="/work/YOU-DARE/scrapers/ffmpeg-7.0.2-amd64-static"
SOURCE_NAME="Fidesz.hu"
...
yt-dlp \
  ...
  -a "/work/YOU-DARE/scrapers/data/Hungary/fidesz_videos_SPIDER/data_fidesz_videos_merged_SPIDER.txt" \
