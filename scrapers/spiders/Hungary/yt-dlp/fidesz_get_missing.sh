...
ARCHIVE_FILE="/work/YOU-DARE/scrapers/data/Hungary/fidesz_YT/archive_missing.txt"
...
yt-dlp \
  ...
  -a "/work/YOU-DARE/scrapers/data/Hungary/fidesz_videos_YT/unavailable_urls.txt" \
