...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Hungary.PyTube.mom.mom_YT
...
channel_url = 'https://www.youtube.com/@magyaronvedelmimozgalom/videoss'
# source = 'Magyar Onvedelmi Mozgalom (MOM) YouTube'
