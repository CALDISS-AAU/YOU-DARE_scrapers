...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Hungary.PyTube.project_legionary.project_legionary_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/Hungary/project_legionary_YT'
