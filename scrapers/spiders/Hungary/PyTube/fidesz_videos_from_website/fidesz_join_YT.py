...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Hungary.PyTube.fidesz_videos_from_website.fidesz_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/Hungary/fidesz_videos_YT'
dataset_path = f'{directory}/combined_metadata.jl'
