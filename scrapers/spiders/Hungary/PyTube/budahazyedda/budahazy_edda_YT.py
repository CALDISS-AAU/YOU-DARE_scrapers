...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Hungary.PyTube.budahazyedda.budahazy_edda_YT
...
channel_url = 'https://www.youtube.com/@hozzvilagramegegymagyartmo8703/videos'
# source = 'Budaházy Edda YouTube'
