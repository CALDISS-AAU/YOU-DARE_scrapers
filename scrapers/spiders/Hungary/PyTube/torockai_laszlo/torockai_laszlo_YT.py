...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Hungary.PyTube.torockai_laszlo.torockai_laszlo_YT
...
channel_url = 'https://www.youtube.com/c/ToroczkaiL%C3%A1szl%C3%B3Hivatalos/videos'
# source = 'Toroczkai Laszlo YouTube'
