...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.United_Kingdom.PyTube.zoomer_historian.zoomer_historian_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/United_Kingdom/zoomer_historian_YT'
