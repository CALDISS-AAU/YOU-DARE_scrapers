...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.United_Kingdom.PyTube.zoomer_historian.zoomer_historian_for_transcriber_YT
'''

transcriber_prep = Transcriber_data_Functions()

transcriber_prep.clean_transcribed_audio_files_setup(
    base_path='/work/YOU-DARE/scrapers/data/United_Kingdom/zoomer_historian_YT'
)