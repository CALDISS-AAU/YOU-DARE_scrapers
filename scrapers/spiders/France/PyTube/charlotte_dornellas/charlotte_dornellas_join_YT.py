...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.France.PyTube.charlotte_dornellas.charlotte_dornellas_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/France/charlotte_dornellas_YT'
