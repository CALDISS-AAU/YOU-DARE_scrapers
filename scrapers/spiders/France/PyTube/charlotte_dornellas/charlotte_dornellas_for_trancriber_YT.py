...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.France.PyTube.charlotte_dornellas.charlotte_dornellas_for_trancriber_YT
'''

transcriber_prep = Transcriber_data_Functions()

transcriber_prep.clean_transcribed_audio_files_setup(
     base_path='/work/YOU-DARE/scrapers/data/France/charlotte_dornellas_YT'
)
