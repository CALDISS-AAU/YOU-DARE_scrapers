...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.France.PyTube.le_syndicat_de_la_famille.le_syndicat_de_la_famille_for_trancriber_YT
'''

transcriber_prep = Transcriber_data_Functions()

transcriber_prep.clean_transcribed_audio_files_setup(
     base_path='/work/YOU-DARE/scrapers/data/France/le_syndicat_de_la_famille_YT'
)
