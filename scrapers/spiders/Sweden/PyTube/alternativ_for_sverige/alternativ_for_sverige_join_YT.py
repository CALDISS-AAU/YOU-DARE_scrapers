...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Sweden.PyTube.alternativ_for_sverige.alternativ_for_sverige_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/Sweden/alternativ_for_sverige_YT'
