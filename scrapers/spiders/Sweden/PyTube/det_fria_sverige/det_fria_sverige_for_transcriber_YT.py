...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Sweden.PyTube.det_fria_sverige.det_fria_sverige_for_transcriber_YT
'''

transcriber_prep = Transcriber_data_Functions()

transcriber_prep.clean_transcribed_audio_files_setup(
    base_path='/work/YOU-DARE/scrapers/data/Sweden/det_fria_sverige_YT'
)