...
''' To run this scraper from bash do the following:
        ...
        python -m scrapers.spiders.Sweden.PyTube.christian_peterson.christian_peterson_join_YT
'''

transcriber_prep = Transcriber_data_Functions()

directory = '/work/YOU-DARE/scrapers/data/Sweden/christian_peterson_YT'
